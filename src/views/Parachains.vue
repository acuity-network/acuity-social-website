        ...
        <v-card>
          <v-card-text>
            ...
            <div class="ml-4">
              ...
              <div class="body-2 mb-4">This is the current Acuity blockchain. It will serve as the DeFi hub for the Acuity ecosytem. Initially it will run the Acuity Atomic Swap DEX. It will also have private transfers similar to <a target="_blank" href="https://tornado.cash/">Tornado Cash</a>.</div>
