      ...
      <v-col cols="12" md="10">
        <v-card>
          <v-card-text>
            ...
            <div class="body-2 mb-4">On Monday 4th October 2021, Acuity will become federated into a relay chain and multiple parachains. The initial distribution of the Acuity relay chain and all the other parachains will be airdropped from a snapshot of <router-link to="/acu">ACU</router-link> balances. For example, if you hold 10,000 ACU on 4th October 2021, you will receive 10,000 ACR, 10,000 ACF, and 10,000 ACT.</div>
            <div class="ml-4">
