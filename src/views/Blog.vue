    ...
    <v-row>
      ...
      <v-col cols="12" md="10">
        <v-card elevation="10" outlined>
          <v-card-text>
            <div class="text-h5 mb-1">Acuity DEX Now Beta Testing On Mainnets</div>
            <div class="subtitle-2 mb-4">18th November 2022 by Jonathan Brown</div>
            <div class="body-2 mb-4">
              <v-img src="/images/can-print.png" width="400" class="mb-4"></v-img>
              ...
              <div class="text-h6 mb-1">Acuity DEX</div>
              <v-img src="/images/dex-beta.png" class="mb-4"></v-img>
      ...
      <v-col cols="12" md="10">
        <v-card elevation="10" outlined>
          <v-card-text>
            <div class="text-h5 mb-1">Acuity DEX Launch Procedure</div>
            <div class="subtitle-2 mb-4">3rd November 2022 by Jonathan Brown</div>
            <div class="body-2 mb-4">
              <p>The <router-link to="/atomic-swap">Acuity DEX</router-link> is very nearly ready to launch. It will begin cross-chain trading of ACU, and coins and tokens on mainnet EVM blockchains.</p>
        ...
        <v-card elevation="10" outlined>
          <v-card-text>
            ...
            <div class="body-2 mb-4">
              ...
              <div class="text-h6 mb-1">Road To Launch</div>
              <p>
                <ul>
      ...
      <v-col cols="12" md="10">
        <v-card elevation="10" outlined>
          <v-card-text>
            <div class="text-h5 mb-1">Acuity Atomic Swap DEX Launch Update</div>
            <div class="subtitle-2 mb-4">17th August 2022 by Jonathan Brown</div>
            <div class="body-2 mb-4">
              <div class="text-h6 mb-1">Substrate Support</div>
              <p>The <a target="_blank" href="https://github.com/acuity-social/acuity-atomic-swap-pallet">Acuity Atomic Swap Substrate pallet</a> has been updated to the final design of the <router-link to="/atomic-swap">DEX</router-link>. This means that ACU (and any other <a target="_blank" href="https://substrate.io/">Substrate</a> chain that deploys the pallet) will be able to be traded on Acuity DEX.</p>
              <div class="text-h6 mb-1">ERC20 Token Support</div>
              ...
              <v-img src="/images/tokens.png" class="mb-4"></v-img>
              <div class="text-h6 mb-1">Ethereum PoS Merge</div>
        ...
        <v-card elevation="10" outlined>
          <v-card-text>
            ...
            <div class="body-2 mb-4">
              ...
              <div class="text-h6 mb-1">How does it work?</div>
      ...
      <v-col cols="12" md="10">
        <v-card elevation="10" outlined>
          <v-card-text>
            ...
            <div class="subtitle-2 mb-4">18th April 2022 by Jonathan Brown</div>
            <div class="body-2 mb-4">
              <p>The <router-link to="/atomic-swap">Acuity Atomic Swap DEX</router-link> is a spin-out project from the broader Acuity Decentralized Social Media project. Acuity is a rebuild of the MIX social media platform from Ethereum to <a target="_blank" href="https://substrate.io/">Substrate</a>.</p>
